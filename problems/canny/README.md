...
## harris
  ...
  >关于canny算法本身，以下为算法5个主要步骤的大致介绍：
  
  >1.
  
  
  
  >在设计完成后，您可以使用我们提供的canny_test.cpp文件进行基本功能测试。但是，由于在评分时会统一使用评分系统内部的canny_test.cpp，因此请不要将设计写在fast_test.cpp中，fast_test.cpp文件也无需提交。
