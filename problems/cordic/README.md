...
## CORDIC
  ...
  2）项目要求  
  >在设计完成后，您可以使用我们提供的cordiccart2pol_test.cpp文件进行基本功能测试。但是，由于在评分时会统一使用评分系统内部的cordiccart2pol_test.cpp，因此请不要将设计写在cordiccart2pol_test.cpp中，dft_test.cpp文件也无需提交。
